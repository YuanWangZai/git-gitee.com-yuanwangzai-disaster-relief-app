...
<div style="padding:20px">
    <div class="top-bar">
        <div>
            ...
            <div style="font-size:15px">总共隐藏了{{total}}条自救知识</div>
        </div>
        <div></div>
        <div>
    ...
    <el-table :data="tableData" style="margin: 20px 0" border stripe :header-cell-class-name="'headerBg'" @selection-change="handleSelectionChange">
      ...
      <el-table-column label="操作"  width="200" align="center">
        <template slot-scope="scope">
          <el-button type="primary" @click="show(scope.row)" size="mini" plain>显示<i class="el-icon-view"></i></el-button>
  ...
  <div class="bottom-bar">
      ...
      <div style="margin: 10px 0px;">
        <el-button type="info" size="mini" @click="showBatch" style="margin-right:10px">一键显示</el-button>
        <el-popconfirm
